...
public class Constants {
    ...
    public final static String APP_ID = "com.ehyper.iot";
    ...
    public final static String ACTION_INTENT_SUBSCRIBED_MSG_RECEIVED = Constants.APP_ID + "." + "SUBSCRIBED_MSG_RECEIVED";
    public final static String SUBSCRIDED_MSG = "SUBSCRIDED_MSG";
